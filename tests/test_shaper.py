...
def test_env(request):
    ...
    processor.benchmark_dir = benchmark_dir

    level1_tree = processor.parse_fortran_file(level1_module)

    parsed_modules = {"level1_mod": level1_tree}

    module_path = {"level1_mod": level1_module}
...
class TestShaper:
    def test_3_level_deep_shape_resolution(self):
        ...
        shaped_level3 = self.shaper_level1.shaper_subroutine(
            parsed_implicit_level3, "main_caller"
        )
