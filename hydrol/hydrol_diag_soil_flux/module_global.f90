...
MODULE module_global
  ...
  !$ACC DECLARE COPYIN(trois, huit, min_sechiba, numout)
  !$ACC DECLARE CREATE(check_top_ns, dr_ns, mcl, dz, qflux_ns, rootsink, dt_sechiba)
  CONTAINS
  ...
  SUBROUTINE initialization
    ...
    !$ACC UPDATE DEVICE(check_top_ns, dr_ns, mcl, dz, qflux_ns, rootsink, dt_sechiba)
