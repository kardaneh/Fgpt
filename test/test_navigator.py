...
def test_env(request):
    ...
    parsed_modules = {
        "simple_mod": simple_tree,
        "dependent_mod": dependent_tree
    }
    module_path = {
        "simple_mod": simple_module,
        "dependent_mod": dependent_module
        }
...
def setup_method(request):
    ...
    cls.simple_navigator = Navigator(cls.test_dir, cls.simple_tree, cls.parsed_modules, cls.module_path, Logger())
    cls.dependent_navigator = Navigator(cls.test_dir, cls.dependent_tree, cls.parsed_modules, cls.module_path, Logger())
...
class TestNavigator:
    ...
    def test_find_variable_in_module(self):
        ...
        assert isinstance(
            self.simple_navigator.var_declaration[0],
    ...
    def test_variable_finder(self):
        ...
        assert len(self.dependent_navigator.visited_modules_sc) == 2  # dependent_mod and simple_mod
