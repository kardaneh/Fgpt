...
PROGRAM main
  ...
  CALL declarations
  CALL initialization
  CALL read_dummy(veget, veget_max, njsc, ks, nvan, avan, mcr, mcs, mcfc, mcw, soiltile, transpir, F_absorption, reinf_slope_soil, returnflow, reinfiltration, irrigation, evapot, evapot_penm, tot_melt, stempdiag, snow, snowdz, tot_bare_soil, u, v, tq_cdrag, e_frac, altmax, circ_class_biomass, precip_rain, totfrac_nobio, frac_snow_nobio, vevapnu, humrel, ksoil, us, ji, error_flag_hydrol_diag_soil_flux_1, error_flag_hydrol_split_soil_1, error_flag_hydrol_split_soil_2, error_flag_hydrol_split_soil_3, error_flag_hydrol_split_soil_4, error_flag_hydrol_split_soil_5, error_flag_hydrol_split_soil_6, error_flag_hydrol_split_soil_7, error_flag_hydrol_split_soil_8, error_flag_hydrol_split_soil_9, error_flag_hydrol_split_soil_10, error_flag_hydrol_split_soil_11, error_flag_hydrol_split_soil_12, error_flag_hydrol_soil_infilt_1, error_flag_hydrol_root_profile_1, error_flag_hydrol_root_profile_2)
  CALL hydrol_soil(ks, nvan, avan, mcr, mcs, mcfc, mcw, kjpindex, veget, veget_max, soiltile, njsc, reinf_slope_soil, transpir, vevapnu, evapot, evapot_penm, runoff, drainage, returnflow, reinfiltration, irrigation, tot_melt, evap_bare_lim, evap_bare_lim_ns, shumdiag, shumdiag_perma, k_litt, litterhumdiag, humrel, vegstress, drysoil_frac, stempdiag, snow, snowdz, tot_bare_soil, u, v, tq_cdrag, mc_layh, mcl_layh, mc_layh_s, mcl_layh_s, e_frac, ksoil, altmax, root_profile, root_depth, root_deficit, circ_class_biomass, us, precip_rain, totfrac_nobio, frac_snow_nobio, F_absorption)
  mc_cpu = mc
  ae_ns_cpu = ae_ns
  tmc_cpu = tmc
  ...
  !$ACC ENTER DATA COPYIN(ks, nvan, avan, mcr, mcs, mcfc, mcw, veget, veget_max, soiltile, njsc, reinf_slope_soil, transpir, vevapnu, evapot, evapot_penm, runoff, drainage, returnflow, reinfiltration, irrigation, tot_melt, evap_bare_lim, evap_bare_lim_ns, shumdiag, shumdiag_perma, k_litt, litterhumdiag, humrel, vegstress, drysoil_frac, stempdiag, snow, snowdz, tot_bare_soil, u, v, tq_cdrag, mc_layh, mcl_layh, mc_layh_s, mcl_layh_s, e_frac, ksoil, altmax, root_profile, root_depth, root_deficit, circ_class_biomass, us, precip_rain, totfrac_nobio, frac_snow_nobio, F_absorption)
  !$ACC PARALLEL LOOP INDEPENDENT REDUCTION(+:error_flag_hydrol_diag_soil_flux_1, error_flag_hydrol_split_soil_1, error_flag_hydrol_split_soil_2, error_flag_hydrol_split_soil_3, error_flag_hydrol_split_soil_4, error_flag_hydrol_split_soil_5, error_flag_hydrol_split_soil_6, error_flag_hydrol_split_soil_7, error_flag_hydrol_split_soil_8, error_flag_hydrol_split_soil_9, error_flag_hydrol_split_soil_10, error_flag_hydrol_split_soil_11, error_flag_hydrol_split_soil_12, error_flag_hydrol_soil_infilt_1, error_flag_hydrol_root_profile_1, error_flag_hydrol_root_profile_2)
  DO ji = 1, kjpindex
    CALL hydrol_soil_acc(error_flag_hydrol_diag_soil_flux_1, error_flag_hydrol_split_soil_1, error_flag_hydrol_split_soil_2, error_flag_hydrol_split_soil_3, error_flag_hydrol_split_soil_4, error_flag_hydrol_split_soil_5, error_flag_hydrol_split_soil_6, error_flag_hydrol_split_soil_7, error_flag_hydrol_split_soil_8, error_flag_hydrol_split_soil_9, error_flag_hydrol_split_soil_10, error_flag_hydrol_split_soil_11, error_flag_hydrol_split_soil_12, error_flag_hydrol_soil_infilt_1, error_flag_hydrol_root_profile_1, error_flag_hydrol_root_profile_2, ji, ks, nvan, avan, mcr, mcs, mcfc, mcw, kjpindex, veget, veget_max, soiltile, njsc, reinf_slope_soil, transpir, vevapnu, evapot, evapot_penm, runoff, drainage, returnflow, reinfiltration, irrigation, tot_melt, evap_bare_lim, evap_bare_lim_ns, shumdiag, shumdiag_perma, k_litt, litterhumdiag, humrel, vegstress, drysoil_frac, stempdiag, snow, snowdz, tot_bare_soil, u, v, tq_cdrag, mc_layh, mcl_layh, mc_layh_s, mcl_layh_s, e_frac, ksoil, altmax, root_profile, root_depth, root_deficit, circ_class_biomass, us, precip_rain, totfrac_nobio, frac_snow_nobio, F_absorption)
  END DO
  !$ACC END PARALLEL
  !$ACC UPDATE SELF(mc, ae_ns, tmc, profil_froz_hydro_ns, mcl, ru_ns, soil_wet_ns, tmc_litter, dr_ns, vegstressv, humrelv, soil_wet_litter, qflux_ns, resolv, tmat, rhs, kfact_root, undermcr, kk, stmat, water2infilt, srhs, kk_moy, evap_bare_lim, evap_bare_lim_ns, mc_layh, mcl_layh, mc_layh_s, mcl_layh_s, root_deficit, ksoil, us)
  !$ACC EXIT DATA DELETE(ks, nvan, avan, mcr, mcs, mcfc, mcw, veget, veget_max, soiltile, njsc, reinf_slope_soil, transpir, vevapnu, evapot, evapot_penm, runoff, drainage, returnflow, reinfiltration, irrigation, tot_melt, evap_bare_lim, evap_bare_lim_ns, shumdiag, shumdiag_perma, k_litt, litterhumdiag, humrel, vegstress, drysoil_frac, stempdiag, snow, snowdz, tot_bare_soil, u, v, tq_cdrag, mc_layh, mcl_layh, mc_layh_s, mcl_layh_s, e_frac, ksoil, altmax, root_profile, root_depth, root_deficit, circ_class_biomass, us, precip_rain, totfrac_nobio, frac_snow_nobio, F_absorption)
  ...
  ELSE
    ...
    WRITE(*, '(A, 2E25.16)') 'Min and Max of profil_froz_hydro_ns_cpu:', MINVAL(profil_froz_hydro_ns_cpu), MAXVAL(profil_froz_hydro_ns_cpu)
    WRITE(*, *) ''
  END IF
  ...
  IF (error_flag_hydrol_root_profile_1 .GT. 0) THEN
    WRITE(numout, *) 'Warning: in the hydrol_root_profile, error_flag_hydrol_root_profile_1 is > 0 :', error_flag_hydrol_root_profile_1
  ...
  IF (error_flag_hydrol_root_profile_2 .GT. 0) THEN
    WRITE(numout, *) 'Warning: in the hydrol_root_profile, error_flag_hydrol_root_profile_2 is > 0 :', error_flag_hydrol_root_profile_2
  ...
  SUBROUTINE hydrol_soil_acc(error_flag_hydrol_diag_soil_flux_1, error_flag_hydrol_split_soil_1, error_flag_hydrol_split_soil_2, error_flag_hydrol_split_soil_3, error_flag_hydrol_split_soil_4, error_flag_hydrol_split_soil_5, error_flag_hydrol_split_soil_6, error_flag_hydrol_split_soil_7, error_flag_hydrol_split_soil_8, error_flag_hydrol_split_soil_9, error_flag_hydrol_split_soil_10, error_flag_hydrol_split_soil_11, error_flag_hydrol_split_soil_12, error_flag_hydrol_soil_infilt_1, error_flag_hydrol_root_profile_1, error_flag_hydrol_root_profile_2, ji, ks, nvan, avan, mcr, mcs, mcfc, mcw, kjpindex, veget, veget_max, soiltile, njsc, reinf_slope_soil, transpir, vevapnu, evapot, evapot_penm, runoff, drainage, returnflow, reinfiltration, irrigation, tot_melt, evap_bare_lim, evap_bare_lim_ns, shumdiag, shumdiag_perma, k_litt, litterhumdiag, humrel, vegstress, drysoil_frac, stempdiag, snow, snowdz, tot_bare_soil, u, v, tq_cdrag, mc_layh, mcl_layh, mc_layh_s, mcl_layh_s, e_frac, ksoil, altmax, root_profile, root_depth, root_deficit, circ_class_biomass, us, precip_rain, totfrac_nobio, frac_snow_nobio, F_absorption)
    !$ACC ROUTINE SEQ
      ...
      DO jsl = 1, nslm
        DO jv = 2, nvm
          ...
          IF (soiltile(ji, jst_kfact_root) .GT. min_sechiba) THEN
            kfact_root(ji, jsl, jst_kfact_root) = kfact_root(ji, jsl, jst_kfact_root) * MAX((MAXVAL(ks_usda) / ks(ji)) ** (- vegetmax_soil(ji, jv, jst_kfact_root) / 2 * (humcste(jv) * zz(jsl) / mille - un) / deux), un)
          END IF
        END DO
      END DO
    END IF
    ...
    END IF
      ...
      DO jsl = 2, nslm - 1
        tmcint = tmcint + dz(jsl) * (trois * mcint(jsl) + mcint(jsl - 1)) / huit + dz(jsl + 1) * (trois * mcint(jsl) + mcint(jsl + 1)) / huit
      END DO
      ...
      temp = MIN(water2infilt(ji, jst) + irrigation_soil(jst) + reinfiltration_soil - MIN(ae_ns(ji, jst), zero) - MIN(subsinksoil(ji), zero) + precisol_ns(ji, jst), MAX(ae_ns(ji, jst), zero) + MAX(subsinksoil(ji), zero))
      ...
      water2infilt(ji, jst) = water2infilt(ji, jst) + irrigation_soil(jst) + reinfiltration_soil - MIN(ae_ns(ji, jst), zero) - MIN(subsinksoil(ji), zero) + precisol_ns(ji, jst) - temp
      ...
      CALL hydrol_soil_infilt_acc(error_flag_hydrol_soil_infilt_1, ji, ks, nvan, avan, mcr, mcs, mcfc, mcw, kjpindex, jst, njsc, flux_infilt, stempdiag, qinfilt_ns, ru_infilt_ns, check_infilt_ns)
      ...
      CALL hydrol_soil_setup_acc(ji, kjpindex, jst)
        ...
        !! 2.3 We define mcl (liquid water content) based on mc and profil_froz_hydro_ns
        DO jsl = 1, nslm
        mcl(ji, jsl, jst) = MIN(mc(ji, jsl, jst), mcr(ji) + (un - profil_froz_hydro_ns(ji, jsl, jst)) * (mc(ji, jsl, jst) - mcr(ji)))
      ...
      DO jsl = 2, nslm - 1
        tmci = tmci + dz(jsl) * (trois * mcl(ji, jsl, jst) + mcl(ji, jsl - 1, jst)) / huit + dz(jsl + 1) * (trois * mcl(ji, jsl, jst) + mcl(ji, jsl + 1, jst)) / huit
      END DO
      ...
      tmat(ji, 1, 2) = f(ji, 1)
      tmat(ji, 1, 3) = g1(ji, 1)
      rhs(ji, 1) = fp(ji, 1) * mcl(ji, 1, jst) + gp(ji, 1) * mcl(ji, 2, jst) - flux_top - (b(ji, 1) + b(ji, 2)) / deux * (dt_sechiba / one_day) - rootsink(ji, 1, jst)
      !- soil body
        DO jsl = 2, nslm - 1
        tmat(ji, jsl, 1) = e(ji, jsl)
        tmat(ji, jsl, 2) = f(ji, jsl)
        tmat(ji, jsl, 3) = g1(ji, jsl)
        rhs(ji, jsl) = ep(ji, jsl) * mcl(ji, jsl - 1, jst) + fp(ji, jsl) * mcl(ji, jsl, jst) + gp(ji, jsl) * mcl(ji, jsl + 1, jst) + (b(ji, jsl - 1) - b(ji, jsl + 1)) * (dt_sechiba / one_day) / deux - rootsink(ji, jsl, jst)
      END DO
      ...
      tmat(ji, jsl, 2) = f(ji, jsl)
      tmat(ji, jsl, 3) = zero
      rhs(ji, jsl) = ep(ji, jsl) * mcl(ji, jsl - 1, jst) + fp(ji, jsl) * mcl(ji, jsl, jst) + (b(ji, jsl - 1) + b(ji, jsl) * (un - deux * free_drain_coef(ji, jst))) * (dt_sechiba / one_day) / deux - rootsink(ji, jsl, jst)
      ...
      DO jsl = 2, nslm - 1
        tmcf = tmcf + dz(jsl) * (trois * mcl(ji, jsl, jst) + mcl(ji, jsl - 1, jst)) / huit + dz(jsl + 1) * (trois * mcl(ji, jsl, jst) + mcl(ji, jsl + 1, jst)) / huit
      END DO
      ...
      END IF
        ...
        DO jsl = 1, nslm
        mc(ji, jsl, jst) = MAX(mcl(ji, jsl, jst), mcl(ji, jsl, jst) + profil_froz_hydro_ns(ji, jsl, jst) * (mc(ji, jsl, jst) - mcr(ji)))
      ...
      END IF
        ...
        ! top layer = initialization
          DO jsl = 2, nslm - 1
          ! intermediate layers
          dr_force_ns(jst) = dr_force_ns(jst) + dz(jsl) * (trois * dmc(jsl) + dmc(jsl - 1)) / huit + dz(jsl + 1) * (trois * dmc(jsl) + dmc(jsl + 1)) / huit
        END DO
      ...
      ! sum from level 1 to 4
        DO jsl = 2, 4
        tmc_litter(ji, jst) = tmc_litter(ji, jst) + dz(jsl) * (trois * mcl(ji, jsl, jst) + mcl(ji, jsl - 1, jst)) / huit + dz(jsl + 1) * (trois * mcl(ji, jsl, jst) + mcl(ji, jsl + 1, jst)) / huit
      END DO

      ! Subsequent calculation of soil_wet_litter (tmc-tmcw)/(tmcfc-tmcw)
      ! Based on liquid water content
      soil_wet_litter(ji, jst) = MIN(un, MAX(zero, (tmc_litter(ji, jst) - tmc_litter_wilt(ji, jst)) / (tmc_litter_field(ji, jst) - tmc_litter_wilt(ji, jst))))
      ...
      DO jsl = 2, nslm - 1
        sm(jsl) = dz(jsl) * (trois * mcl(ji, jsl, jst) + mcl(ji, jsl - 1, jst)) / huit + dz(jsl + 1) * (trois * mcl(ji, jsl, jst) + mcl(ji, jsl + 1, jst)) / huit
        smt(jsl) = dz(jsl) * (trois * mc(ji, jsl, jst) + mc(ji, jsl - 1, jst)) / huit + dz(jsl + 1) * (trois * mc(ji, jsl, jst) + mc(ji, jsl + 1, jst)) / huit
      ...
      END DO
        ...
        root_deficit(ji) = SUM(MAX(zero, beta_irrig * smf(ji, 1 : nslm_root(ji)) - sm(ji, 1 : nslm_root(ji)))) - water2infilt(ji, jst)
      ...
      CALL hydrol_root_profile_acc(error_flag_hydrol_root_profile_1, error_flag_hydrol_root_profile_2, ji, kjpindex, altmax, sm, smw, root_profile, root_depth)
        ...
        DO jv = 2, nvm
          ! AD16*** Although plants can only withdraw liquid water, we compute here the water stress
            ...
            IF ((sm(jsl) - smw(jsl)) .GT. min_sechiba) THEN
              us(ji, jv, jst, jsl) = MIN(un, MAX(zero, (EXP(- alpha_watstress * ((smf(jsl) - smw(jsl)) / (sm_nostress(jsl) - smw(jsl))) * ((sm_nostress(jsl) - sm(jsl)) / (sm(jsl) - smw(jsl))))))) * root_profile(ji, jv, jsl, ifunc)
            ELSE
              us(ji, jv, jst, jsl) = 0.
            END IF
          ELSE
            us(ji, jv, jst, jsl) = MIN(un, MAX(zero, (sm(jsl) - smw(jsl)) / (sm_nostress(jsl) - smw(jsl)))) * root_profile(ji, jv, jsl, ifunc)
          END IF
      ...
      DO jv = 2, nvm
        DO jsl = 1, nslm
          vegstressv(ji, jv, jst) = vegstressv(ji, jv, jst) + MIN(un, MAX(zero, (sm(jsl) - smw(jsl)) / (smf(jsl) - smw(jsl)))) * root_profile(ji, jv, jsl, ifunc)
        END DO
      END DO
    ...
    evap_bare_lim_ns(ji, :) = zero
      ...
      tmat(ji, 1, 2) = f(ji, 1)
      tmat(ji, 1, 3) = g1(ji, 1)
      rhs(ji, 1) = fp(ji, 1) * mcl(ji, 1, jst) + gp(ji, 1) * mcl(ji, 2, jst) - flux_top - (b(ji, 1) + b(ji, 2)) / deux * (dt_sechiba / one_day)
      !- soil body
        DO jsl = 2, nslm - 1
        tmat(ji, jsl, 1) = e(ji, jsl)
        tmat(ji, jsl, 2) = f(ji, jsl)
        tmat(ji, jsl, 3) = g1(ji, jsl)
        rhs(ji, jsl) = ep(ji, jsl) * mcl(ji, jsl - 1, jst) + fp(ji, jsl) * mcl(ji, jsl, jst) + gp(ji, jsl) * mcl(ji, jsl + 1, jst) + (b(ji, jsl - 1) - b(ji, jsl + 1)) * (dt_sechiba / one_day) / deux
      END DO
      !- Last layer
      jsl = nslm
      tmat(ji, jsl, 1) = e(ji, jsl)
      tmat(ji, jsl, 2) = f(ji, jsl)
      tmat(ji, jsl, 3) = zero
      rhs(ji, jsl) = ep(ji, jsl) * mcl(ji, jsl - 1, jst) + fp(ji, jsl) * mcl(ji, jsl, jst) + (b(ji, jsl - 1) + b(ji, jsl) * (un - deux * free_drain_coef(ji, jst))) * (dt_sechiba / one_day) / deux
    ...
    CALL xios_orchidee_send_field("ksat", ksat)
    ! mm/d (for CMIP6, once)
    CALL xios_orchidee_send_field("psi_moy", psi_moy)
    ! mm (for SP-MIP)
    CALL xios_orchidee_send_field("wtd", wtd)
    ! in m
    CALL xios_orchidee_send_field("ru_corr", ru_corr / dt_sechiba)
    ! adjustment flux added to surface runoff (included in runoff)
    CALL xios_orchidee_send_field("ru_corr2", ru_corr2 / dt_sechiba)
    CALL xios_orchidee_send_field("dr_corr", dr_corr / dt_sechiba)
    ! adjustment flux added to drainage (included in drainage)
    CALL xios_orchidee_send_field("dr_corrnum", dr_corrnum / dt_sechiba)
    CALL xios_orchidee_send_field("dr_force", dr_force / dt_sechiba)
    ! adjustement flux added to drainage to sustain a forced wtd
    CALL xios_orchidee_send_field("qinfilt", qinfilt / dt_sechiba)
    CALL xios_orchidee_send_field("ru_infilt", ru_infilt / dt_sechiba)
    CALL xios_orchidee_send_field("r_soil", r_soil)
    ! s/m
      ...
      CALL xios_orchidee_send_field("qflux", qflux / dt_sechiba)
      ! upward water flux at the low interface of each layer
      CALL xios_orchidee_send_field("check_top", check_top / dt_sechiba)
      !water budget residu in top layer
    END IF
  ...
  END SUBROUTINE hydrol_soil_acc
    ...
    END IF
      ...
      DO jsl = 2, nslm - 1
        DO ji = 1, kjpindex
          tmcint(ji) = tmcint(ji) + dz(jsl) * (trois * mcint(ji, jsl) + mcint(ji, jsl - 1)) / huit + dz(jsl + 1) * (trois * mcint(ji, jsl) + mcint(ji, jsl + 1)) / huit
        END DO
      END DO
      DO ji = 1, kjpindex
      ...
      END DO
        ...
        ! Here, temp is used as a temporary variable to store the min of water to infiltrate vs evaporate
        DO ji = 1, kjpindex
        temp(ji) = MIN(water2infilt(ji, jst) + irrigation_soil(ji, jst) + reinfiltration_soil(ji) - MIN(ae_ns(ji, jst), zero) - MIN(subsinksoil(ji), zero) + precisol_ns(ji, jst), MAX(ae_ns(ji, jst), zero) + MAX(subsinksoil(ji), zero))
      END DO
        ...
        DO ji = 1, kjpindex
        !Note that in tag 2.0, irrigation_soil(ji), changed to be coherent with new variable dimension
        water2infilt(ji, jst) = water2infilt(ji, jst) + irrigation_soil(ji, jst) + reinfiltration_soil(ji) - MIN(ae_ns(ji, jst), zero) - MIN(subsinksoil(ji), zero) + precisol_ns(ji, jst) - temp(ji)
      END DO
      ...
      !! The conductivity comes from hydrol_soil_coef and relates to the liquid phase only
      !  This seems consistent with ok_freeze
      CALL hydrol_soil_infilt(ks, nvan, avan, mcr, mcs, mcfc, mcw, kjpindex, jst, njsc, flux_infilt, stempdiag, qinfilt_ns, ru_infilt_ns, check_infilt_ns)
      ...
      DO jsl = 2, nslm - 1
        tmci(:) = tmci(:) + dz(jsl) * (trois * mcl(:, jsl, jst) + mcl(:, jsl - 1, jst)) / huit + dz(jsl + 1) * (trois * mcl(:, jsl, jst) + mcl(:, jsl + 1, jst)) / huit
      END DO
      ...
      resolv(:) = (mask_soiltile(:, jst) .GT. 0)
        ...
        tmat(ji, 1, 2) = f(ji, 1)
        tmat(ji, 1, 3) = g1(ji, 1)
        rhs(ji, 1) = fp(ji, 1) * mcl(ji, 1, jst) + gp(ji, 1) * mcl(ji, 2, jst) - flux_top(ji) - (b(ji, 1) + b(ji, 2)) / deux * (dt_sechiba / one_day) - rootsink(ji, 1, jst)
      END DO
      !- soil body
        DO jsl = 2, nslm - 1
        DO ji = 1, kjpindex
      ...
      DO jsl = 2, nslm - 1
        tmcf(:) = tmcf(:) + dz(jsl) * (trois * mcl(:, jsl, jst) + mcl(:, jsl - 1, jst)) / huit + dz(jsl + 1) * (trois * mcl(:, jsl, jst) + mcl(:, jsl + 1, jst)) / huit
      END DO
      ...
      DO ji = 1, kjpindex
        IF (ru_ns(ji, jst) .LT. zero) THEN
          IF (printlev >= 3) WRITE(numout, *) 'NEGATIVE RU_NS: runoff and drainage before correction', ru_ns(ji, jst), dr_ns(ji, jst)
          dr_ns(ji, jst) = dr_ns(ji, jst) + ru_ns(ji, jst)
      ...
      END IF
        ...
        DO jsl = 2, nslm - 1
          ! intermediate layers
            DO ji = 1, kjpindex
            dr_force_ns(ji, jst) = dr_force_ns(ji, jst) + dz(jsl) * (trois * dmc(ji, jsl) + dmc(ji, jsl - 1)) / huit + dz(jsl + 1) * (trois * dmc(ji, jsl) + dmc(ji, jsl + 1)) / huit
          END DO
        END DO
        DO ji = 1, kjpindex
      ...
      DO jsl = 2, nslm - 1
        sm(:, jsl) = dz(jsl) * (trois * mcl(:, jsl, jst) + mcl(:, jsl - 1, jst)) / huit + dz(jsl + 1) * (trois * mcl(:, jsl, jst) + mcl(:, jsl + 1, jst)) / huit
        smt(:, jsl) = dz(jsl) * (trois * mc(:, jsl, jst) + mc(:, jsl - 1, jst)) / huit + dz(jsl + 1) * (trois * mc(:, jsl, jst) + mc(:, jsl + 1, jst)) / huit
          ...
          DO ji = 1, kjpindex
            ! AD16*** Although plants can only withdraw liquid water, we compute here the water stress
              ...
              IF ((sm(ji, jsl) - smw(ji, jsl)) .GT. min_sechiba) THEN
                us(ji, jv, jst, jsl) = MIN(un, MAX(zero, (EXP(- alpha_watstress * ((smf(ji, jsl) - smw(ji, jsl)) / (sm_nostress(ji, jsl) - smw(ji, jsl))) * ((sm_nostress(ji, jsl) - sm(ji, jsl)) / (sm(ji, jsl) - smw(ji, jsl))))))) * root_profile(ji, jv, jsl, ifunc)
              ELSE
                us(ji, jv, jst, jsl) = 0.
              END IF
            ELSE
              us(ji, jv, jst, jsl) = MIN(un, MAX(zero, (sm(ji, jsl) - smw(ji, jsl)) / (sm_nostress(ji, jsl) - smw(ji, jsl)))) * root_profile(ji, jv, jsl, ifunc)
            END IF
            humrelv(ji, jv, jst) = humrelv(ji, jv, jst) + us(ji, jv, jst, jsl)
          END DO
        END DO
      ...
      DO jv = 2, nvm
        DO ji = 1, kjpindex
          DO jsl = 1, nslm
            vegstressv(ji, jv, jst) = vegstressv(ji, jv, jst) + MIN(un, MAX(zero, (sm(ji, jsl) - smw(ji, jsl)) / (smf(ji, jsl) - smw(ji, jsl)))) * root_profile(ji, jv, jsl, ifunc)
          END DO
        END DO
      END DO
    ...
    evap_bare_lim_ns(:, :) = zero
      ...
      END DO
        ...
        tmat(ji, 1, 2) = f(ji, 1)
        tmat(ji, 1, 3) = g1(ji, 1)
        rhs(ji, 1) = fp(ji, 1) * mcl(ji, 1, jst) + gp(ji, 1) * mcl(ji, 2, jst) - flux_top(ji) - (b(ji, 1) + b(ji, 2)) / deux * (dt_sechiba / one_day)
      END DO
      !- soil body
        DO jsl = 2, nslm - 1
        DO ji = 1, kjpindex
      ...
      END DO
        ...
        ! we can only hope they are not too large because we don't add water at this stage...
        DO ji = 1, kjpindex
        evap_bare_lim_ns(ji, jst) = mask_soiltile(ji, jst) * (tmcint(ji) - tmc(ji, jst) - flux_bottom(ji) - SUM(rootsink(ji, :, jst)))
      END DO
  ...
  SUBROUTINE read_dummy(veget, veget_max, njsc, ks, nvan, avan, mcr, mcs, mcfc, mcw, soiltile, transpir, F_absorption, reinf_slope_soil, returnflow, reinfiltration, irrigation, evapot, evapot_penm, tot_melt, stempdiag, snow, snowdz, tot_bare_soil, u, v, tq_cdrag, e_frac, altmax, circ_class_biomass, precip_rain, totfrac_nobio, frac_snow_nobio, vevapnu, humrel, ksoil, us, ji, error_flag_hydrol_diag_soil_flux_1, error_flag_hydrol_split_soil_1, error_flag_hydrol_split_soil_2, error_flag_hydrol_split_soil_3, error_flag_hydrol_split_soil_4, error_flag_hydrol_split_soil_5, error_flag_hydrol_split_soil_6, error_flag_hydrol_split_soil_7, error_flag_hydrol_split_soil_8, error_flag_hydrol_split_soil_9, error_flag_hydrol_split_soil_10, error_flag_hydrol_split_soil_11, error_flag_hydrol_split_soil_12, error_flag_hydrol_soil_infilt_1, error_flag_hydrol_root_profile_1, error_flag_hydrol_root_profile_2)
    ...
    REAL(KIND = r_std), DIMENSION(kjpindex, nslm, nstm) :: ksoil
    REAL(KIND = r_std), DIMENSION(kjpindex, nvm) :: humrel
    REAL(KIND = r_std), DIMENSION(kjpindex) :: vevapnu
    REAL(KIND = r_std), DIMENSION(kjpindex, nnobio) :: frac_snow_nobio
    REAL(KIND = r_std), DIMENSION(kjpindex) :: totfrac_nobio
    ...
    error_flag_hydrol_root_profile_1 = 2
    error_flag_hydrol_root_profile_2 = 2
