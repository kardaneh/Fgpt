...
class FortranSearcher:
    def __init__(self, module_path, parsed_modules, org_files_loaded, logger=None):
        ...
        ----------
            processor : Processor
                object providing `logger` and `parse_fortran_file` methods.
            module_path : dict
                maps module names -> source file paths.
            parsed_modules : dict
                maps module names -> parsed fparser trees.
        """
        self.module_path = module_path
        self.parsed_modules = parsed_modules
    ...
    def search_subroutine_in_dependencies(
        self, subroutine_name, current_module_name, current_dir
    ):
        """
