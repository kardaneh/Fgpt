...
class JaxConverter(
    ...
    def __init__(
        ...
        self.cls_name = (
            list(cls_info.keys())[0] if len(cls_info) == 1 else list(cls_info.keys())
        )
        ...
        # Sub-transformers
        self.analyzer = VectorizationAnalyzer(vectorize=self.vectorize)
        ...
        self.call_edge: CallEdge | list = []
        self.ret_per_func: dict = {}
        self.fn_index: dict = {}

        # Local-scope definition tracking (scope stack mirrors lexical blocks) which is mostly used in the case of vectorization
        ...
        # Defines the current vectorized loops's loop variable
        self._vector_loop_stack: list[str] = []

        self._seen_assigned_names: set[str] = set()
        self._chain_pre_existing: dict[str, bool] = {}
        ...
        try:
            ...
            if self._control_stack:
                ...
                self._expr_depends_on_axes(
                    node, vectorization_context.get("vectorization_axis", {})
                )
    ...
    def check_if_array(
        ...
        try:
            ...
            func_locals = self.cls_info[self.cls_name]["methods"][self.func_name].get(
                "local_arr", {}
            )
    ...
    def set_working_function(
        self, func_name: str, func_input_dim: dict, call_edge: CallEdge | list
    ) -> None:
        """
    ...
    def reset_all(self) -> None:
        ...
        self._mask_counter = 0
        self._outer_func_args = None
        self._var_modif = {"attr": set(), "args": set()}
        self.var_state = {}
        ...
        self._seen_assigned_names = set()
        self._chain_pre_existing = {}
