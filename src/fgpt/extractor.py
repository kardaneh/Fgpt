...
from fgpt.navigator import FortranSearcher, Navigator
from fgpt.processor import Processor
from fgpt.shaper import Shaper
...
class Extractor:
    ...
    def _process_intent_assignment_statement(
        self, child, child_parent, dummy_arg_list, usage
    ):
        """ """
    ...
    def _process_intent_call_statement(
        self, child, child_parent, dummy_arg_list, usage, within_calls
    ):
        """ """
        call_name = None
    ...
    def find_variables(
        self, subroutine_tree, subroutine_key, parent_subroutine_key=None
    ):
        """ """
    ...
    def find_global_variables(
        self, module_dir, module_tree, var_global, subroutine_key
    ):
        """
